...
#
# Author:        finnr
# Maintainer:    $Id: HMMResults.pm,v 1.1 2016/08/03 21:23:20 jig2114 Exp $
...
$Id: HMMResults.pm,v 1.1 2016/08/03 21:23:20 jig2114 Exp $
...
sub eachHMMSeq {
  ...
  foreach my $n (sort keys %{ $seqRefs }){
    push(@seqs, $seqRefs->{$n});
  }
  return(\@seqs);
}
...
sub lowestTrue {
  ...
  unless($self->domTC && $self->seqTC) {
    ...
    foreach my $seqId (sort keys %{$self->seqs} ){
